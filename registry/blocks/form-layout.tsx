            ...
            <div key={field.name}>
              ...
              {field.rows ? (
                <textarea
                  ...
                  className="w-full rounded-lg border border-border bg-white px-3 py-2 text-base text-foreground placeholder:text-muted-foreground focus-visible:border-primary focus-visible:outline-none disabled:bg-muted disabled:text-muted-foreground disabled:cursor-not-allowed"
                />
              ) : (
                <Input
                  id={field.name}
